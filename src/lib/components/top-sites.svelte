  ...
  {:else}
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
      {#each sites as site (site.url)}
        <a
          href={site.url}
          class="group flex flex-col items-center gap-3 rounded-2xl bg-card/70 p-4 text-center transition hover:bg-card focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
        >
